...
def main(argv: list[str] | None = None) -> int:
    ...
    generator = PresetInspirerGenerator(provider=provider)
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Generate open-ended inspirational use-case questions.")
    parser.add_argument("--input-json", type=str, help="Path to JSON file containing context fields plus output_language.")
    ...
    parser.add_argument("--career-context", "--careercontext", dest="career_context", type=str)
...
def load_context_data(args: argparse.Namespace) -> dict[str, Any]:
    ...
    values = {
        ...
        "course": args.course,
        "topic": args.topic,
        "career_context": args.career_context,
