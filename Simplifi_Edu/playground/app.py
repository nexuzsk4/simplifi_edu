...
from preset_question_agent.cli import build_run_record, write_run_record
from preset_question_agent.config import load_settings
from preset_question_agent.models import ValidationError
from preset_question_agent.providers import make_provider
from preset_question_agent.service import PresetQuestionGenerator
...
def main() -> None:
    st.set_page_config(page_title="Preset Question Playground", layout="wide")
    st.title("Preset Question Playground")
    st.caption("Interactive live playground for preset question generation.")
    ...
    topic = st.text_input("topic", value="", placeholder="เช่น ลิมิตและความต่อเนื่อง, ภาคตัดกรวย")
    ...
    if st.button("Generate", type="primary", use_container_width=True):
        try:
            ...
            generator = PresetQuestionGenerator(provider=llm_provider)
...
def run_with_live_progress(generator: PresetQuestionGenerator, payload: dict) -> tuple:
...
def reload_agent_logic() -> None:
    ...
    import preset_question_agent.cli as cli_module
    import preset_question_agent.config as config_module
    import preset_question_agent.models as models_module
    import preset_question_agent.pricing as pricing_module
    import preset_question_agent.prompt as prompt_module
    import preset_question_agent.providers as providers_module
    import preset_question_agent.service as service_module

    global build_run_record, load_settings, make_provider, PresetQuestionGenerator, ValidationError, write_run_record
    ...
    PresetQuestionGenerator = service_module.PresetQuestionGenerator
